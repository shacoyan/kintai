      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3">
          <input
            ...
            disabled={!canEdit}
            className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 disabled:opacity-50 disabled:cursor-not-allowed"
          />
          <input
            type="time"
            value={timeStr}
