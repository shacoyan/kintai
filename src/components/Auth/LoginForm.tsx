  ...
  if (showResetForm) {
    return (
      ...
      >
        ...
        {resetSuccess ? (
          <div className="rounded-md bg-emerald-50 dark:bg-emerald-800/30 p-3 text-sm text-emerald-700 dark:text-emerald-100">
      ...
      {isLogin ? (
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs font-medium text-blue-600 hover:text-blue-700 dark:hover:text-blue-200 hover:underline"
          >
            パスワードをお忘れですか？
          </button>
        </div>
