    ...
    <div className="flex flex-col items-center gap-2">
      {status === 'working' && (
        <button
          ...
          aria-label="休憩開始"
          aria-pressed={false}
          className="bg-slate-600 hover:bg-slate-700 dark:bg-slate-500 text-white font-bold py-3 px-8 rounded-lg motion-safe:transition-colors active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
        >
          {processing ? '処理中...' : '休憩開始'}
        </button>
      )}
