        ...
        <div className="flex flex-wrap gap-2">
          {presets.map((p) => (
            <button
              ...
              className="inline-flex items-center px-3 py-1.5 text-xs font-medium bg-primary-50 text-primary-700 border border-primary-200 rounded-full hover:bg-primary-100 transition"
            >
