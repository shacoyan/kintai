        ...
        <div className="flex flex-wrap gap-2">
          {presets.map((p) => (
            <button
              ...
              className="inline-flex items-center px-3 py-2 text-xs font-medium bg-primary-50 dark:bg-primary-900 text-primary-700 dark:text-primary-300 border border-primary-200 dark:border-primary-800 rounded-full hover:bg-primary-100 dark:hover:bg-primary-900 motion-safe:transition"
            >
