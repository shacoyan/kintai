...
/** ステータスフィルタで扱う全値 (pending_preference は擬似 status) */
...
/** localStorage 保存キー (v2) */
export const STATUS_FILTER_STORAGE_KEY = 'kintai.shift.statusFilter.v2';
