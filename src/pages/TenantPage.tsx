  ...
  if (error && pageState === 'select') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 p-4">
        <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md border border-neutral-100 text-center">
          ...
          <h2 className="text-lg font-bold text-neutral-900 mb-2">エラーが発生しました</h2>
          <p className="text-sm text-neutral-600 mb-6">{error}</p>
          <button
            onClick={() => fetchTenants()}
            className="px-6 py-2 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            再読み込み
          </button>
        </div>
